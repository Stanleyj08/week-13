...
public class DefaultJeepOrderDao implements JeepOrderDao {
	...
	/**
	  ...
	  public List<Option> fetchOptions(List<String> optionIds) {
	    ...
	    return (List<Option>) jdbcTemplate.query(sql, params, new RowMapper<Option>() {
	      @Override
	...
	@Override
	public Jeep fetchModel(@NotNull JeepModel model) {
	...
	@Override
	public Order saveOrder(Optional<Customer> customer, Jeep jeep, Color color, Engine engine, Tire tire,
			BigDecimal price) {
		// TODO Auto-generated method stub
		return null;
	}
